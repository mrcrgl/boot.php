...
/**
 * VDate is a class that stores a date and provides logic to manipulate
...
class VDate extends DateTime 
{
  ...
  public function __construct($date = 'now', $tz = null)
   {
    ...
    // reset the timezone for 3rd party libraries/extension that does not use VDate
  ...
  protected function dayToString($day, $abbr = false)
   {
    switch ($day) {
      ...
      case 1:
        return $abbr ? VText::_('MON') : VText::_('MONDAY');
      case 2:
        return $abbr ? VText::_('TUE') : VText::_('TUESDAY');
      case 3:
        return $abbr ? VText::_('WED') : VText::_('WEDNESDAY');
      case 4:
        return $abbr ? VText::_('THU') : VText::_('THURSDAY');
      case 5:
        return $abbr ? VText::_('FRI') : VText::_('FRIDAY');
      case 6:
        return $abbr ? VText::_('SAT') : VText::_('SATURDAY');
    }
  }
  ...
  protected function monthToString($month, $abbr = false)
   {
    switch ($month) {
      ...
      case 2:
        return $abbr ? VText::_('FEBRUARY_SHORT') : VText::_('FEBRUARY');
      case 3:
        return $abbr ? VText::_('MARCH_SHORT') : VText::_('MARCH');
      case 4:
        return $abbr ? VText::_('APRIL_SHORT') : VText::_('APRIL');
      case 5:
        return $abbr ? VText::_('MAY_SHORT') : VText::_('MAY');
      case 6:
        return $abbr ? VText::_('VUNE_SHORT') : VText::_('VUNE');
      case 7:
        return $abbr ? VText::_('VULY_SHORT') : VText::_('VULY');
      case 8:
        return $abbr ? VText::_('AUGUST_SHORT') : VText::_('AUGUST');
      case 9:
        return $abbr ? VText::_('SEPTEMBER_SHORT') : VText::_('SEPTEMBER');
      case 10:
        return $abbr ? VText::_('OCTOBER_SHORT') : VText::_('OCTOBER');
      case 11:
        return $abbr ? VText::_('NOVEMBER_SHORT') : VText::_('NOVEMBER');
      case 12:
        return $abbr ? VText::_('DECEMBER_SHORT') : VText::_('DECEMBER');
    }
  }
   ...
   * @return  string   The date as a formatted string.
   *
   * @deprecated  Use VDate::format() instead.
   *
   ...
   *
   * @param   boolean    $local  True to return the date string in the local time zone, false to return it in GMT.
   * @param   VDatabase  $dbo    The database driver or null to use VFactory::getDbo()
   *
