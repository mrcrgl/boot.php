 ...
 */
$_VPassword_NumberOfPossibleCharacters = 0;

/**
 * Main class for the VPassword package
 *
 * @category   Text
 * @package    VPassword
 * @author     Martin Jansen <mj@php.net>
    ...
    function create($length = 10, $type = 'pronounceable', $chars = '')
     {
        ...
        case 'pronounceable' :
        default :
            return VPassword::_createPronounceable($length);
        }
    }
    ...
    function createMultiple($number, $length = 10, $type = 'pronounceable', $chars = '')
     {
        ...
        while ($number > 0) {
            while (true) {
                $password = VPassword::create($length, $type, $chars);
    ...
    function _createPronounceable($length)
     {
        ...
        $_VPassword_NumberOfPossibleCharacters = $v_count + $c_count;
    ...
    function _createUnpronounceable($length, $chars)
     {
         ...
         */
         ...
         case 'alphanumeric':
             ...
             $_VPassword_NumberOfPossibleCharacters = 62;
             break;

         case 'alphabetical':
             $chars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
             $_VPassword_NumberOfPossibleCharacters = 52;
             break;

         case 'numeric':
             $chars = '0123456789';
             $_VPassword_NumberOfPossibleCharacters = 10;
             break;

         case '':
             $chars = '_#@%&ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789';
             $_VPassword_NumberOfPossibleCharacters = 67;
             break;
         ...
         default:
             ...
             $_VPassword_NumberOfPossibleCharacters = strlen($chars);
         }
          ...
          */
         for ($i = 0; $i < $length; $i++) {
             $num = mt_rand(0, $_VPassword_NumberOfPossibleCharacters - 1);
             $password .= $chars{$num};
         }
