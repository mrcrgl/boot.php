 ...
 * @since       11.1
 */
abstract class VSessionStorage extends VObject 
{
    /**
     * @var    array  VSessionStorage instances container.
     * @since  11.3
     */
    ...
    public static function getInstance($options = array())
     {
        $name = VSettings::f('session.storage', 'none');
            ...
            if (!class_exists($class)) 
{
                ...
                if (file_exists($path)) {
                    ...
                    // No call to VError::raiseError here, as it tries to close the non-existing session
                    // TODO
