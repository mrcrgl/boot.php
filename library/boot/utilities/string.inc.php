 ...
 */
BLoader::import('phputf8.utf8');
BLoader::import('phputf8.strcasecmp');
...
abstract class BString
{
    ...
    {
        BLoader::import('phputf8.utf8_substr');
        if ($length === false) {
    ...
    {
        BLoader::file('phputf8.str_ireplace');
        if ($count === false) {
    ...
    {
        BLoader::file('phputf8.str_split');
    ...
    public static function sanitize($__string)
    {
        ...
        $__string = strtr($__string, BString::$sanitize_chars);
    ...
    {
        if (count(BString::$sanitize_chars) > 0) {
            return true;
        }

        BString::$sanitize_chars = array(
            chr(195).chr(128) => 'A',
            chr(195).chr(160) => 'a',
            chr(195).chr(129) => 'A',
            chr(195).chr(161) => 'a',
    ...
    {
        return implode('', BArray::ucfirst(explode('_', $__string)));
    }
    ...
    public static function camelcase_to_underscores($__string)
    {
        ...
        $parts = BArray::strip_empty_values($parts);
