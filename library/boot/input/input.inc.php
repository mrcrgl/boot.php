...
class BInput
{
    ...
    /**
     * Options array for the BInput instance.
     *
     * @var    array
     * @since  2.0
     */
     ...
     *
     * @return  BInput  The request input object
     *
     * @since   2.0
     */
    public function __get($name)
     {
        if (isset($this->aInputs[$name])) {
            return $this->aInputs[$name];
        }

        $className = 'BInput' . $name;
        if (class_exists($className)) {
            $this->aInputs[$name] = new $className(null, $this->options);
            return $this->aInputs[$name];
        }
