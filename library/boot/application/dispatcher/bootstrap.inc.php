...
BLoader::import('boot.application.dispatcher.default');
BLoader::discover(VROOT.DS.'models'.DS.'language');

class BDispatcherBootstrap extends RequestDispatcher 
{
    ...
    function getRequestView()
 {
    ...
    if (isset($language) && BFactory::getLanguage()->country_code != $language->country_code) {
        ...
        if (!$newView && count($this->_args) < 1) {
            ...
            $this->headerLocation(404, '/'.BFactory::getLanguage()->country_code.'/'.$this->_viewDefault);
    ...
    public function changeView($_view, $bCache=FALSE)
        ...
        */
        ...
        #BInstance::_new(&$this->_view, 'view');
