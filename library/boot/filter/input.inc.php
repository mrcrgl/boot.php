 ...
 * @since       2.0
 */
class BFilterInput extends BObject 
{
    /**
     * @var    array  A container for BFilterInput instances.
     * @since  11.3
     */
   ...
   * @param   integer  $xssAuto     Only auto clean essentials = 0, Allow clean blacklisted tags/attr = 1
   *
   * @return  BFilterInput  The BFilterInput object.
   *
   * @since   2.0
   */
  public static function &getInstance($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1)
   {
      ...
      if (empty(self::$instances[$sig])) {
          self::$instances[$sig] = new BFilterInput($tagsArray, $attrArray, $tagsMethod, $attrMethod, $xssAuto);
      }
